...
def upgrade():
    ...
    op.create_table('token_blocklist',
                    ...
                    sa.Column('type', sa.String(length=16),
                              server_default='access_token', nullable=False),
                    sa.ForeignKeyConstraint(['user_id'], ['user.id'], ),
                    sa.PrimaryKeyConstraint('id')
                    )
    with op.batch_alter_table('token_blocklist', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_token_blocklist_jti'), [
                              'jti'], unique=False)
    ...
    op.create_table('card_checklist_item',
                    ...
                    sa.ForeignKeyConstraint(
                        ['activity_id'], ['card_activity.id'], ),
                    sa.ForeignKeyConstraint(
                        ['checklist_id'], ['card_checklist.id'], ),
                    sa.PrimaryKeyConstraint('id')
                    )
